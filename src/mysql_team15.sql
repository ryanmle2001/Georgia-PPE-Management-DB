...
CREATE TABLE inventory (
  ...
  zip decimal(5,0) not null,
  primary key (business_name),
  CONSTRAINT iventory_ibfk_1 FOREIGN KEY (business_name) REFERENCES business (business_name)
) engine = InnoDB;
...
('RDMSK','mask','red'),
('GRMSK','mask','green'),
('WHRES','respirator','white'),
('YLRES','respirator','yellow'),
('ORRES','repirator','orange'),
('CLSHD','shield','clear'),
('GRGOG','goggles','green'),
('ORGOG','goggles','orange'),
('WHGOG','goggles','white'),
('BKGOG','goggles','black'),
('BLSHC','shoe cover','blue'),
('BLHOD','hood','blue'),
('BLGWN','gown','blue'),
('GRSHC','shoe cover','green'),
('GRHOD','hood','green'),
('GRGWN','gown','green'),
('GYSHC','shoe cover','grey'),
('GYHOD','hood','grey'),
('GYGWN','gown','grey'),
('WHSHC','shoe cover','white'),
('WHHOD','hood','white'),
('WHGWN','gown','white'),
('BKSTE','stethoscope','black'),
('WHSTE','stethoscope','white'),
('SISTE','stethoscope','silver'),
('BKGLO','gloves','black'),
('WHGLO','gloves','white'),
('GRGLO','gloves','green');
...
('WHMSK','PPE Empire',1.25),
('BLMSK','PPE Empire',1.35),
('RDMSK','PPE Empire',1.30),
('GRMSK','PPE Empire',1.45),
('WHRES','PPE Empire',4.80),
('YLRES','PPE Empire',5.10),
('ORRES','PPE Empire',4.50),
('BLSHC','Buy Personal Protective Equipment, Inc',0.90),
('BLHOD','Buy Personal Protective Equipment, Inc',2.10),
('BLGWN','Buy Personal Protective Equipment, Inc',3.15),
('GRSHC','Buy Personal Protective Equipment, Inc',0.90),
('GRHOD','Buy Personal Protective Equipment, Inc',2.10),
('GRGWN','Buy Personal Protective Equipment, Inc',3.15),
('GYSHC','Buy Personal Protective Equipment, Inc',0.90),
('GYHOD','Buy Personal Protective Equipment, Inc',2.10),
('GYGWN','Buy Personal Protective Equipment, Inc',3.15),
('WHSHC','Buy Personal Protective Equipment, Inc',0.90),
('WHHOD','Buy Personal Protective Equipment, Inc',2.10),
('WHGWN','Buy Personal Protective Equipment, Inc',3.15),
('ORGOG','Healthcare Supplies of Atlanta',3.00),
('RDMSK','Healthcare Supplies of Atlanta',1.45),
('CLSHD','Healthcare Supplies of Atlanta',6.05),
('BLSHC','Healthcare Supplies of Atlanta',1.00),
('BLHOD','Healthcare Supplies of Atlanta',2.00),
('BLGWN','Healthcare Supplies of Atlanta',3.00),
('YLRES','Healthcare Supplies of Atlanta',5.50),
('WHMSK','Healthcare Supplies of Atlanta',1.10),
('BLMSK','Healthcare Supplies of Atlanta',1.05),
('CLSHD','Georgia Tech Protection Lab',5.95),
('ORGOG','Georgia Tech Protection Lab',3.20),
('WHGOG','Georgia Tech Protection Lab',3.20),
('BKGOG','Georgia Tech Protection Lab',3.20),
('GYSHC','Georgia Tech Protection Lab',0.75),
('GYHOD','Georgia Tech Protection Lab',1.80),
('GYGWN','Georgia Tech Protection Lab',3.25),
('GRSHC','Marietta Mask Production Company',0.80),
('GRHOD','Marietta Mask Production Company',1.65),
('GRGWN','Marietta Mask Production Company',2.95),
('GRMSK','Marietta Mask Production Company',1.25),
('GRGOG','Marietta Mask Production Company',3.25),
('BKSTE','S&J Corporation',5.20),
('WHSTE','S&J Corporation',5.00),
('SISTE','S&J Corporation',5.10),
('BKGLO','S&J Corporation',0.30),
('WHGLO','S&J Corporation',0.30),
('GRGLO','S&J Corporation',0.30);
...
INSERT INTO doctor VALUES ('drCS4400','Children\'s Healthcare of Atlanta', null),
...
('S&J Corporation','Stash St','Suwanee','Suwanee',30024);
...
(0001,'Children\'s Healthcare of Atlanta','2020-03-10'),
(0002,'Children\'s Healthcare of Atlanta','2020-03-10'),
(0003,'Emory Midtown','2020-03-10'),
(0004,'Grady Hospital','2020-03-10'),
(0005,'Northside Hospital','2020-03-10'),
(0006,'Children\'s Healthcare of Atlanta','2020-03-10'),
(0007,'Piedmont Hospital','2020-03-10'),
(0008,'Northside Hospital','2020-05-01'),
(0009,'Children\'s Healthcare of Atlanta','2020-05-01'),
(0010,'Northside Hospital','2020-05-01'),
(0011,'Northside Hospital','2020-05-01'),
(0012,'Emory Midtown','2020-05-25'),
(0013,'Children\'s Healthcare of Atlanta','2020-05-25'),
(0014,'Emory Midtown','2020-05-25'),
(0015,'Emory Midtown','2020-05-25'),
(0016,'Northside Hospital','2020-05-25'),
(0017,'Grady Hospital','2020-06-03'),
(0018,'Grady Hospital','2020-06-03'),
(0019,'Grady Hospital','2020-06-03'),
(0020,'Piedmont Hospital','2020-06-03'),
(0021,'Piedmont Hospital','2020-06-04');

INSERT INTO usage_log VALUES 
('10000','2020-11-06 16:30:00','fantastic'),
('10001','2020-06-11 17:00:00','jekyll_not_hyde'),
('10002','2020-06-11 17:03:00','young_doc'),
('10003','2020-06-12 8:23:00','fantastic'),
('10004','2020-06-12 8:42:00','hannah_hills'),
('10005','2020-06-12 9:00:00','mcdreamy'),
('10006','2020-06-12 9:43:00','fantastic'),
('10007','2020-06-12 10:11:00','doctor1'),
('10008','2020-06-12 10:12:00','Jones01'),
('10009','2020-06-12 10:23:00','henryjk'),
('10010','2020-06-12 10:32:00','bones'),
('10011','2020-06-12 11:00:00','dr_dolittle'),
('10012','2020-06-12 11:14:00','drake_remoray '),
('10013','2020-06-12 12:11:00','allons_y'),
('10014','2020-06-12 13:23:00','dr_mory'),
('10015','2020-06-12 13:52:00','Jones01');

INSERT INTO has_item VALUES 
...
('WHMSK',0001,500,'PPE Empire'),
('BLMSK',0001,500,'PPE Empire'),
('BLSHC',0002,300,'Buy Personal Protective Equipment, Inc'),
('BLMSK',0003,500,'Healthcare Supplies of Atlanta'),
('ORGOG',0004,150,'Healthcare Supplies of Atlanta'),
('RDMSK',0004,150,'Healthcare Supplies of Atlanta'),
('CLSHD',0004,200,'Healthcare Supplies of Atlanta'),
('BLSHC',0004,100,'Healthcare Supplies of Atlanta'),
('WHMSK',0005,300,'Healthcare Supplies of Atlanta'),
('BLSHC',0006,400,'Buy Personal Protective Equipment, Inc'),
('GRMSK',0007,100,'Marietta Mask Production Company'),
('GRGOG',0007,300,'Marietta Mask Production Company'),
('ORGOG',0008,200,'Georgia Tech Protection Lab'),
('WHGOG',0008,200,'Georgia Tech Protection Lab'),
('GRSHC',0009,500,'Marietta Mask Production Company'),
('GRHOD',0009,500,'Marietta Mask Production Company'),
('WHGLO',0010,500,'S&J Corporation'),
('WHHOD',0011,200,'Buy Personal Protective Equipment, Inc'),
('WHGWN',0011,200,'Buy Personal Protective Equipment, Inc'),
('BLSHC',0012,50,'Buy Personal Protective Equipment, Inc'),
('BLHOD',0013,100,'Healthcare Supplies of Atlanta'),
('BLGWN',0013,100,'Healthcare Supplies of Atlanta'),
('WHRES',0014,300,'PPE Empire'),
('YLRES',0014,200,'PPE Empire'),
('ORRES',0014,300,'PPE Empire'),
('GYGWN',0015,50,'Buy Personal Protective Equipment, Inc'),
('CLSHD',0016,20,'Healthcare Supplies of Atlanta'),
('ORGOG',0016,300,'Healthcare Supplies of Atlanta'),
('BLHOD',0016,100,'Healthcare Supplies of Atlanta'),
('RDMSK',0017,200,'Healthcare Supplies of Atlanta'),
('CLSHD',0017,180,'Healthcare Supplies of Atlanta'),
('WHHOD',0018,500,'Buy Personal Protective Equipment, Inc'),
('GYGWN',0019,300,'Buy Personal Protective Equipment, Inc'),
('BKSTE',0020,50,'S&J Corporation'),
('WHSTE',0020,50,'S&J Corporation'),
('CLSHD',0021,100,'Georgia Tech Protection Lab'),
('ORGOG',0021,200,'Georgia Tech Protection Lab');

INSERT INTO used_by VALUES 
('GRMSK',10000,3),
('GRGOG',10000,3),
('WHSTE',10000,1),
('GRMSK',10001,5),
